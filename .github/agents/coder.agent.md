...
## Project Knowledge
- **Tech Stack:** Azure Functions (Python v2), Azure Event Hubs, Microsoft Fabric, Power BI, Bicep, GitHub Actions
- **Languages:** Python 3.11
- **Package Manager:** pip (requirements.txt)
- **Build Command:** `cd functions && pip install -r requirements.txt`
- **Test Command:** `cd functions && pytest tests/`
- **Lint Command:** `ruff check functions/` (Python), `az bicep lint --file infra/main.bicep` (Bicep)
